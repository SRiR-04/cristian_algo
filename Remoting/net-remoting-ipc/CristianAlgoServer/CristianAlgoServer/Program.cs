...
namespace CristianAlgoServer
{
    ...
    class Server
    {
        static void Main(string[] args)
        {
            ...
            IpcChannel ipcChannel = new IpcChannel("serverIpc");  ///stworzenie kanału komunikacji z uwzględnieniem protokołu IPC oraz nazwą portu
            ChannelServices.RegisterChannel(ipcChannel, true);  ///zarejstrowanie utworzonego portu

            Type commonInterfaceType = Type.GetType("Cristian");    ///pobranie typu interfejsu łączącego klienta z serwerem
